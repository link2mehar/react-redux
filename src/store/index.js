...
export const addtoCart = (id,title,qty,price) => {
    return {
        type:ADD_TO_CART,
        payload:{
            id,
    ...
    switch(action.type){
        case ADD_TO_CART :
            ...
            return{
              ...
              ...state,
              cart:[...state.cart,{id:action.payload.id,title:action.payload.title,qty:action.payload.qty,price:action.payload.price}]
